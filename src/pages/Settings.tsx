...
const DEFAULT_TEMPLATES: Omit<WhatsAppTemplate, "id">[] = [
  {
    template_id: "welcome_kid",
    name: "Welcome Message (Kid)",
    description: "Sent to parent when a Kid student is enrolled",
    template: `🏸 Welcome to RJ Sportz!\n\nDear {parent_name},\n\nYour child has been successfully enrolled and we are so excited to have them!\n\nStudent: {student_name}\nStudent ID: {student_id}\nSport: {sport_name}\nCommunity: {community_name}\nBatch: {batch_type} • {age_group}\nMonthly Fee: ₹{monthly_fee}\nNext Due Date: {next_due_date}\n\nPlease ensure {student_name} comes with:\n✅ Comfortable sportswear\n✅ Water bottle\n✅ Lots of energy!\n\nWe look forward to seeing {student_name} grow with us! 🌱\n\nRJ Sportz Team`,
    variables: ["parent_name", "student_name", "student_id", "sport_name", "community_name", "batch_type", "age_group", "monthly_fee", "next_due_date"],
  },
  {
    template_id: "welcome_adult",
    name: "Welcome Message (Adult)",
    description: "Sent to parent when an Adult student is enrolled",
    template: `🏆 Welcome to RJ Sportz!\n\nDear {parent_name},\n\n{student_name} has been successfully enrolled. We are glad to have them on board!\n\nStudent: {student_name}\nStudent ID: {student_id}\nSport: {sport_name}\nCommunity: {community_name}\nBatch: {batch_type} • {age_group}\nMonthly Fee: ₹{monthly_fee}\nNext Due Date: {next_due_date}\n\nOur coaches will work closely to help {student_name} achieve their sporting goals. Consistency and regular attendance will make all the difference!\n\nWelcome aboard! 🎯\n\nRJ Sportz Team`,
    variables: ["parent_name", "student_name", "student_id", "sport_name", "community_name", "batch_type", "age_group", "monthly_fee", "next_due_date"],
  },
  {
